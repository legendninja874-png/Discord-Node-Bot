...
__export(schema_exports, {
  ...
  antiNukeCtbyTable: () => antiNukeCtbyTable,
  antiNukeSnapshotsTable: () => antiNukeSnapshotsTable,
...
var antiNukeSnapshotsTable = pgTable("antinuke_snapshots", {
  guildId: text("guild_id").notNull(),
  executorId: text("executor_id").notNull(),
  data: jsonb("data").notNull().default({}),
  updatedAt: timestamp("updated_at", { withTimezone: true }).notNull().defaultNow()
}, (t) => [primaryKey({ columns: [t.guildId, t.executorId] })]);
var antiNukeCtbyTable = pgTable("antinuke_ctby", {
  guildId: text("guild_id").primaryKey(),
  userIds: text("user_ids").array().notNull().default([])
});
